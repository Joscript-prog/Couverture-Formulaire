...
(function () {
    ...
    async function buildReportHtml() {
        ...
        <div style="font-family: Calibri, Arial, sans-serif; color:#222; font-size:12px; line-height:1.4;">
            ${bandeauTitre(titrePrincipal, (typeof clientBannerText === "function" ? clientBannerText("│") : "Bouygues Telecom │ IPKONEKT"))}
        ...
        html += `<div style="margin-top:18px; padding-top:6px; border-top:1px solid #ccc;
                    ...
                    ${(typeof clientFooterText === "function" ? clientFooterText() : "Document confidentiel — Usage interne IPKONEKT / Bouygues Telecom")}
                 </div>`;
